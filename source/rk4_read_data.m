...
xlabel('t');
ylabel('y(t)');
legend('rugekutta4','ode23','ode45','ode113','Location','Northeastoutside');
title('ODE solution RK4 C++ and MATLAB');
%
subplot(2,1,2);
...
title('ODE \Delta, RK4 C++ and MATLAB');
legend('ML = ode23','ML = ode45','ML = ode113','Location','Northeastoutside');
...
for j=1:DIM
    ...
    legend('rugekutta4','ode23','ode45','ode113','Location','Northeastoutside');
    title(['ODE y' num2str(j) ' RK4 C++ and MATLAB']);
    %
    subplot(2,1,2);
    ...
    title(['ODE \Delta' num2str(j) ' , RK4 C++ and MATLAB']);
    legend('ML = ode23','ML = ode45','ML = ode113','Location','Northeastoutside');
    %
    figname = 'fig_rk4_sys';
    fignumb = num2str(j);
